...
/**
 * @author: cxz
 * @create: 2020/12/19 13:57
 * @description: 台湾站点定价
 **/
public class TWMakePrice {

    public static void main(String[] args) {
        System.out.println(makePrice(2, 5, 100, 1,true,10d,false));
    }
    /**
     *  台湾比/人民币 汇率
     */
    ...
    /**
     * @author: cxz
     * @create: 2020/12/19 14:02
     * @param:  [buyPrice, profit, weight, shopType]
     * @return: void
     * @description:
     */
